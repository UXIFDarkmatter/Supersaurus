(() => {
  ...
  const SLOTS = [
    ...
    { src: N + "image_14.jpg",        left: 2,   top: 50,  width: 19, rot: -2, z: 2, clip: "polygon(6% 0, 100% 2%, 94% 100%, 0 98%)" },
    { src: N + "20210324_130600.jpg", left: -4,  top: 76,  width: 20, rot: 4,  z: 3 },

    // RIGHT column (4)
    { src: N + "spud_game.jpg",       left: 80,  top: -5,  width: 19, rot: 3,  z: 2 },
    { src: N + "image_12.jpg",        left: 83,  top: 26,  width: 17, rot: -3, z: 3, clip: "polygon(0 3%, 100% 0, 100% 97%, 6% 100%)" },
    { src: N + "image_15.jpg",        left: 82,  top: 54,  width: 19, rot: 4,  z: 2 },
